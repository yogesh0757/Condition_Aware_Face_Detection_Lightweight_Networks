...
from data import WiderFaceDetection, detection_collate, preproc, cfg_CAFACLite, cfg_BV4, cfg_MV1, cfg_SV2
...
net = CAFACLite(cfg_net=cfg_net, cfg=cfg)
print("Printing net...")
print(net)
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 10 == 0 and epoch > 0) or (epoch % 5 == 0 and epoch > cfg['decay1']):
                torch.save(net.state_dict(), save_folder + cfg['name'] + '_CAFACLite' + '_epoch_' + str(epoch) + '.pth')
            epoch += 1
